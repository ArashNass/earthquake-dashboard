...
.ea-bar{display:none;align-items:center;gap:16px;background:#b45309;padding:12px 22px;flex-shrink:0;overflow:hidden;box-shadow:0 2px 10px rgba(0,0,0,.15)}
.ea-bar.ea-show{display:flex}
.ea-label{display:flex;align-items:center;gap:7px;font-size:12px;font-weight:800;letter-spacing:.8px;color:#fff;white-space:nowrap;flex-shrink:0;background:#7c2d12;padding:5px 12px;border-radius:4px}
...
.ea-item{color:#fff;text-decoration:none;font-size:14px;font-weight:600;padding:0 4px}
.ea-item:hover{color:#fff5eb;text-decoration:underline}
.ea-sep{color:#fbd0a0;margin:0 26px;font-size:12px}
.ea-more{flex-shrink:0;color:#fff;font-size:10.5px;font-weight:700;text-decoration:none;white-space:nowrap}
.ea-more:hover{text-decoration:underline}
.ea-filter{flex-shrink:0;background:#92400e;color:#fff;border:1px solid #fbd0a0;border-radius:5px;font-size:11px;font-weight:700;padding:5px 9px;cursor:pointer}
.ea-filter:hover{border-color:#fff}
.ea-filter option{background:#7c2d12;color:#fff}
